...
/*
 * Determines whether one array is a rotation of the other. A rotation means that the rotated array starts at a different index.
 */
...
public class ArrayRotations {
    ...
    // Finds the point where values of arrays match, then goes through both arrays forward to make sure each value after is equal
