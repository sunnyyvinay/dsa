 ...
 * 
 * MergeSort is a stable, divide and conquer algorithm. It divides input array in two halves, calls
 * itself for the two halves and then merges the two sorted halves. The merge() functions is used
